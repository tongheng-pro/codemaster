                ...
                <form onSubmit={handleSubmit} className="space-y-8">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    className="w-full px-3 py-2 rounded-xl border text-xs bg-slate-50 dark:bg-slate-950 font-mono"
                                    required
                                />
                            </div>
                    ...
                    <div className="space-y-6">
                        ...
                        {questions.map((q, qIdx) => (
                            <div key={qIdx} className="rounded-2xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 p-6 shadow-xs space-y-4">
                                ...
                                <div className="space-y-2 pt-2 border-t">
                                    ...
                                    {q.answers.map((ans, aIdx) => (
                                        <div key={aIdx} className="flex items-center gap-3 p-2 bg-slate-50 dark:bg-slate-950 rounded-xl border text-xs">
                                            <input
                                                type="radio"
                                                name={`correct_${qIdx}`}
