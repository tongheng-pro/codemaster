                        ...
                        <tbody className="divide-y divide-neutral-100 dark:divide-neutral-800">
                            {lessons.map((l) => (
                                <tr key={l.id} className="hover:bg-neutral-50 dark:hover:bg-neutral-800/40">
                                    ...
                                    <td className="p-4 font-mono text-neutral-500">{l.slug}</td>
                                    <td className="p-4">
                                        {l.has_km ? (
                                    ...
                                    <td className="p-4 text-right">
                                        <div className="flex items-center justify-end gap-2">
                                            <Link
                                                ...
                                                className="p-1.5 rounded-lg border border-neutral-200 dark:border-neutral-800 hover:bg-neutral-100 dark:hover:bg-neutral-800 text-neutral-600"
                                                title="View Lesson"
                                                target="_blank"
                                            >
