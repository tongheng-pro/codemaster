...
export default function Show({ course }: Props) {
    ...
    return (
        <AppLayout title={course.title || course.slug}>
            ...
            {/* Course Hero Banner */}
            <div className="border-b border-neutral-200 dark:border-neutral-800 bg-white dark:bg-neutral-900 py-12">
                <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6">
                        ...
                        <Link
                            href={startUrl}
                            className="px-6 py-3 rounded-xl bg-primary-600 hover:bg-primary-500 text-white font-semibold text-sm transition-all shadow-md flex items-center gap-2 shrink-0 hover:scale-102"
                        >
                    ...
                    {course.completed_percentage !== undefined && course.completed_percentage !== null && course.completed_percentage > 0 && (
                        <div className="mt-8 p-4 rounded-xl bg-neutral-50 dark:bg-neutral-800/60 border border-neutral-200 dark:border-neutral-700/60">
                            <div className="flex justify-between text-xs font-semibold mb-2">
                                <span className="text-neutral-600 dark:text-neutral-300">Course Progress</span>
                                <span className="text-primary-600 dark:text-primary-400">{course.completed_percentage}%</span>
                            </div>
                ...
                {course.sections && course.sections.length > 0 ? (
                    <div className="space-y-6">
                        {course.sections.map((section) => (
                            ...
                            >
                                <div className="px-6 py-4 bg-neutral-50/70 dark:bg-neutral-800/40 border-b border-neutral-100 dark:border-neutral-800">
                                ...
                                <div className="divide-y divide-neutral-100 dark:divide-neutral-800/60">
                                    {section.lessons?.map((lesson) => (
                                        <Link
                                            ...
                                            className="px-6 py-3.5 flex items-center justify-between hover:bg-neutral-50 dark:hover:bg-neutral-800/60 transition-colors group"
                                        >
                        ...
                        {course.lessons?.map((lesson) => (
                            ...
                            >
                                <div className="flex items-center gap-3">
                                    ...
                                    <span className="text-sm font-medium text-neutral-900 dark:text-white group-hover:text-primary-600 dark:group-hover:text-primary-400">
                                        {lesson.title}
                                    </span>
                                </div>
                                <ChevronRight className="w-4 h-4 text-neutral-300 group-hover:translate-x-0.5 transition-transform" />
